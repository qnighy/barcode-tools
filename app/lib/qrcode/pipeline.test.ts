...
import { decodeFromMatrix, DecodeToMatrixResult, encodeToMatrix, EncodeToMatrixResult } from "./pipeline";
...
test("encodeToMatrix example on Annex I QR code", () => {
  ...
  } satisfies EncodeToMatrixResult)
});

test("decodeFromMatrix example on Annex I QR code", () => {
  const matrix = new BitExtMatrix(21, [
    3, 3, 3, 3, 3, 3, 3, 2, 4, 1, 0, 1, 1, 2, 3, 3, 3, 3, 3, 3, 3,
    3, 2, 2, 2, 2, 2, 3, 2, 4, 1, 1, 1, 1, 2, 3, 2, 2, 2, 2, 2, 3,
    3, 2, 3, 3, 3, 2, 3, 2, 5, 0, 0, 0, 0, 2, 3, 2, 3, 3, 3, 2, 3,
    3, 2, 3, 3, 3, 2, 3, 2, 5, 1, 0, 0, 0, 2, 3, 2, 3, 3, 3, 2, 3,
  ...
  const result = decodeFromMatrix(matrix);
  expect(result).toEqual({
    version: 1,
    errorCorrectionLevel: "M",
    text: "01234567",
  } satisfies DecodeToMatrixResult)
});
